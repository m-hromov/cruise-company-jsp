...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/js/chosen-js/chosen.css">
    <script src="https://code.jquery.com/jquery-3.6.1.min.js"
            integrity="sha256-o88AwQnZB+VDvE9tvIXrMQaPlFFSUTR+nldQm1LuPXQ="
            crossorigin="anonymous"></script>

    <script src="${pageContext.request.contextPath}/js/chosen-js/chosen.jquery.min.js"
            crossorigin="anonymous"></script>
    <script>
...
<div class="container auth-box">
    <form class="col flex-column" action="${pageContext.request.contextPath}/cruise/add_ship" method="post"
