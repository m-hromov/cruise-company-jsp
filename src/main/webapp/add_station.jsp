...
<head>
  ...
  <title>Add Station | Cruise company</title>
</head>
<body>
<jsp:include page="page_elements/header.jsp"/>

<div class="container auth-box">
  <form class="col flex-column" action="cruise/add_station" method="post" enctype="multipart/form-data">
    <div class="row">
      <div class="col px-1 mb-2">
        <label for="city" class="ms-2 position-absolute mtext">
          <span class="h6 small bg-white text-muted px-1">City</span>
        </label>
    ...
    <div class="row">
      <div class="col px-1 mb-2">
        <label for="country" class="ms-2 position-absolute mtext">
          <span class="h6 small bg-white text-muted px-1">Country</span>
        </label>
