            ...
            <c:if test="${sessionScope.role=='ADMIN'}">
                    ...
                    <ul class="dropdown-menu" style="right: 0;left: auto;">
                        <li>
                            <a class="dropdown-item"
                               href="${pageContext.request.contextPath}/cruise/add_cruise">Cruise</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/cruise/add_ship">Ship</a>
                        </li>
                        <li>
                            <a class="dropdown-item"
                               href="${pageContext.request.contextPath}/cruise/add_staff">Staff</a>
                        </li>
                        <li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" style="right: 0;left: auto;">
                        <li>
                            <a class="dropdown-item"
                               href="${pageContext.request.contextPath}/cruise/edit_cruise">Cruise</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/cruise/edit_ship">Ship</a>
                        </li>
                    </ul>
                </li>
            </c:if>
            ...
            <c:if test="${sessionScope.role.equals('ADMIN')||sessionScope.role.equals('USER')}">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" style="right: 0;left: auto;">
                        <c:if test="${sessionScope.role.equals('USER')}">
                            <li>
                                <a class="dropdown-item" href="${pageContext.request.contextPath}/cruise/edit_money">
                                    Balance: <utils:currency value="${sessionScope.user.money}" convertedcurr="UAH"/>
                                </a>
                            </li>
                            </li>
                            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/cruise/edit_profile">Edit
                                profile</a></li>
                            <li>
                        ...
                        <li><a class="dropdown-item" href="${pageContext.request.contextPath}/cruise/sign_out">Sign
                            out</a></li>
                    </ul>
                </li>
            </c:if>
