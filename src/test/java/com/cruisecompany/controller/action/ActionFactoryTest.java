...
class ActionFactoryTest {
    ...
    static Stream<Arguments> actionNames(){
        return Stream.of(
                ...
                Arguments.arguments("do_edit_profile_info",new EditProfileInfoAction()),
                Arguments.arguments("do_edit_profile_document",new EditProfileDocumentAction()),
                Arguments.arguments("do_edit_profile_password",new EditProfilePasswordAction()),
